		...
		<div>	
			...
			<div data-ng-if="searchBoard != null" data-ng-repeat="list in searchBoard | limitTo : 5">
				<div style="margin-bottom : 5px; margin-top : 5px;">
					...
					<div class="row">
						 <div class="col-md-2">{{list.BOARD_WRITER}}</div>
						 <div class="col-md-2">{{list.BOARD_DATE}}</div>
					</div>
				</div>
			</div>
		...
		<div style="margin-top : 20px;">
			...
			<div data-ng-if="searchNotice != null" data-ng-repeat="list in searchNotice | limitTo : 5">
				<div style="margin-bottom : 5px; margin-top : 5px;">
					...
					<div class="row">
						 <div class="col-md-2">{{list.NOTICE_WRITER}}</div>
						 <div class="col-md-2">{{list.NOTICE_DATE}}</div>
					</div>
				</div>
			</div>
